...
public class CMPPConnectMessage extends CMPPMessage
{
        ...
        throws IllegalArgumentException
    {
        ...
        System.arraycopy(source_Addr.getBytes(Charsets.UTF_8), 0, super.buf, 12, source_Addr.length());
        ...
        int tmploc = 0;
        System.arraycopy(source_Addr.getBytes(Charsets.UTF_8), 0, tmpbuf, 0, source_Addr.length());
