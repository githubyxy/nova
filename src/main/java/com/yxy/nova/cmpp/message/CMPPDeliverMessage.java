...
public class CMPPDeliverMessage extends CMPPMessage
{
    ...
    public String getDestnationId()
    {
        ...
        return (new String(tmpId, Charsets.UTF_8)).trim();
    }
    ...
    public String getReserve()
    {
        ...
        return (new String(tmpReserve, Charsets.UTF_8)).trim();
    }
    ...
    public String getStat()
    {
        if(deliverType == 1)
        {
            ...
            return (new String(tmpStat, Charsets.UTF_8)).trim();
        } else
        {
            return null;
        }
    ...
    public Date getSubmitTime()
    {
        if(deliverType == 1)
        {
            ...
            String tmpstr = new String(tmpbyte, Charsets.UTF_8);
            int tmpYear = 2000 + Integer.parseInt(tmpstr);
            System.arraycopy(super.buf, 86, tmpbyte, 0, 2);
            tmpstr = new String(tmpbyte, Charsets.UTF_8);
    ...
    public String getDestTerminalId()
    {
        if(deliverType == 1)
        {
            ...
            return new String(tmpId, Charsets.UTF_8);
        } else
        {
            return null;
        }
    ...
    public String toString()
    {
        ...
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MsgId=").append(new String(getMsgId(), Charsets.UTF_8))));
        ...
        {
            tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MsgContent=").append(new String(getMsgContent(), Charsets.UTF_8))));
        }
