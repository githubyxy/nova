...
public class CMPPQueryRepMessage extends CMPPMessage
{
    ...
    public Date getDate()
    {
        ...
        String tmpYear = new String(tmpstr, Charsets.UTF_8);
        byte tmpstr1[] = new byte[2];
        System.arraycopy(super.buf, 8, tmpstr1, 0, 2);
        String tmpMonth = new String(tmpstr1, Charsets.UTF_8);
        System.arraycopy(super.buf, 10, tmpstr1, 0, 2);
        String tmpDay = new String(tmpstr1, Charsets.UTF_8);
    ...
    public String getQueryCode()
    {
        ...
        return (new String(tmpQC, Charsets.UTF_8)).trim();
    }
